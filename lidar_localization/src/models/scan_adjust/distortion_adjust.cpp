...
namespace lidar_localization
{
    ...
    bool DistortionAdjust::AdjustCloud(CloudData::CLOUD_PTR &input_cloud_ptr, CloudData::CLOUD_PTR &output_cloud_ptr)
    {
        ...
        transform_2.matrix() = transform_matrix.inverse();
        // transform_2.rotation = transform_matrix.inverse().block<3 , 3>(0 , 0);

        pcl::transformPointCloud(*output_cloud_ptr, *output_cloud_ptr, transform_2);
        return true;
    }
